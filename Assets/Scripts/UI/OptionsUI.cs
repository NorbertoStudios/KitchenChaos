...
public class OptionsUI : MonoBehaviour
{
    ...
    {
        soundEffectsText.text = "Sound Effects: " + Mathf.Round(SoundManager.Instance.GetVolume() * multiplier);
        musicText.text = "Music: " + Mathf.Round(MusicManager.Instance.GetVolume() * multiplier);
